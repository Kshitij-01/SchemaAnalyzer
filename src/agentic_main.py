    ...
    return {
        ...
        "verification": AgentDefinition(
            ...
            prompt=(
                ...
                "definitive answer\n\n"
                "## Be Thorough\n"
                "Give a clear, definitive answer.  If your first query doesn't "
                "fully resolve the question, run a follow-up.  The asking agent "
                "is blocked until you respond, so make sure your answer is "
                "complete enough that they don't need to ask again.\n\n"
                "## Output Format\n"
